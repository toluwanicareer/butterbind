...
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by H-->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=0">
    <meta name="copyright" content="Copyright Swyfft LLC 2018" />
    <meta name="description" content="Swyfft is disrupting the homeowners insurance industry by using big dat">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-6 col-md-offset-3 quote-preview-container-ly quote-preview-container-md">
                ...
                <h2 class="preview-annual-premium-price-bs" data-bind="text:formatCurrencyUS(grossAnnualPayment())" id="annualPremium">${{annual_premium|intcomma}}</h2>
            </div>
        </div>
        <div class="row">
                    ...
                    <ul id="preview-deductible-choices" class="options-check" data-bind="foreach:visibleChoices, disableEdit:quoteVm.disabled() || !element.isEditable()">
                        ...
                        <li data-bind="attr:{id:'main_' + element.name() + '_' + value()}" id="main_Deductible_500">
                            <label  class="choice main-choice-bs jcf-label-active disableEdit">
                                <strong class="quoteChoiceText main-choice-text-bs main-choice-text-st" data-bind="text:name, css:{quoteChoiceWithImage:imageUrl}">{{choice.Name}}</strong>
                                <span class="jcf-radio choice-element-btn-md modify-choice-element-btn-md main-choice-btn-md jcf-checked" data-bind="css:{'jcf-checked':isSelected(), 'jcf-unchecked':!isSelected(), quoteChoiceImage:imageUrl}, style:{'background-image':'url(' + (imageUrl() || '/Images/Transparent.gif') + ')'}" style="background-image: url(&quot;/Images/Transparent.gif&quot;);">
                                    <input type="radio" data-bind="attr:{name:name, value:value}, checked: value" style="position: absolute; opacity: 0" name="$500" value="500">
                                </span>
                            </label>
                        </li>
                        {% endfor %}
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 col-md-offset-3">
                <div class="rc-template-container-md" id="rc-template-container" data-bind="template:{name:'mainReplacementCostTemplate', data:rcElementVm}">
                    ...
                    <label class="errorLabelOn" data-bind="validationMessage: element.value, attr:{id:element.name() + 'MainError'}" id="ReplacementCostMainError" style="display: none;"></label>
                </div>
                </div>
            </div>
        </div>
    ...
    <section class="quote-warnings-list-container-bs">
        <div class="quote-warnings-line-container-ly" data-bind="foreach: quoteWarnings">
            <div class="row">
                ...
                <div class="quote-step" id="sliders">
                    <div id="demo">

                        <div id="sliderSection" class="quote-element-container-bs">
<div class="container">
    <div class="row">
        <div class="col-lg-3 col-lg-offset-9 col-md-3 col-md-offset-9 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3">
            <h1 class="reset-defaults-md" data-bind="visible:isAdmin() && resetValuesEnabled(), enable: !disabled()">
                <a data-bind="click:reset" id="btnReset">Reset Values</a>
            </h1>
        </div>
    </div>
</div>
...
<!-- Mirrored from www.swyfft.com/quote by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Sep 2018 08:12:53 GMT -->
</html>